...
export default function Home() {
  ...
  return (
    <main className="h-screen overflow-hidden p-8 md:p-12 flex flex-col items-center relative">
      ...
      >
        <h1 className="text-5xl font-bold glow-text tracking-tight">
          Spam<span className="text-cyan-400">Detector</span>
        </h1>
      ...
      <footer className="mt-auto py-6 text-gray-600 text-xs">
        &copy; 2026 SpamDetector. Built for security.
      </footer>
    </main>
  );
}
